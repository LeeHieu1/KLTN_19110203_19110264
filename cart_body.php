...
<body>
    ...
    <div class="wrapper">
                    ...
                    <div class="tableWrapper">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td data-label="Sản phẩm"><img src="admin/<?php echo $product_image_1; ?>" alt=""></td>
                                    <td data-label="Tên sản phẩm"><a class="tableTitle" href="details.php?product_id=<?php echo $product_id; ?>"><?php echo $product_title; ?></a></td>
                                    <td data-label="Số lượng">
                                        <input class="quantity inputNumber" type="text" name="quantity" data-product_id="<?php echo $product_id; ?>" value="<?php echo $_SESSION['product_quantity']; ?>">
                                    </td>
                                    ...
                                    <td data-label="Xoá">
                                        <input class="inputCheckBox" type="checkbox" id="check" name="remove[]" value="<?php echo $product_id; ?>">
        ...
        <!--Footer-->
        <footer class="footer">
            <p class="footer__text">A project made by <a href="chibaosinger.github.io" target="_blank" rel="noopener"
                    class="link">Chibaosinger</a></p>
