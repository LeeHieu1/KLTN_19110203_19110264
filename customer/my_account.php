<?php
    ...
    function delete(){
        ...
        $delete = "DELETE FROM customer_orders WHERE order_id = ?";
...
<body>
    ...
    <nav class="mainNav">
        ...
        <div class="mainNav__wrapper">
            <div class="mainNav__links">
                ...
                <a class="mainNav__link" href="my_account.php">Tài khoản</a>
                <a class="mainNav__link" href="../cart.php">Giỏ hàng</a>
        ...
        <div class="mainNav__menu">
            ...
            <div class="mainNav__profile">
                ...
                <div class="mainNav__profileMenu">
                    <a href="my_account.php?my_orders" class="mainNav__profileText account"> <?xml version="1.0"?>
                        ...
                        Hồ sơ</a>
                    <a href="my_account.php?edit_account" class="mainNav__profileText"> <?xml version="1.0"?>
                        ...
                        Chỉnh sửa hồ sơ</a>
                    <a href="my_account.php?change_password" class="mainNav__profileText"> <?xml version="1.0"?>
                        ...
                        Cài đặt tài khoản</a>
                    <a href="logout.php" class="mainNav__profileText"> <?xml version="1.0"?>
    ...
    <div class="wrapper">
        ...
        <!--Footer-->
        <footer class="footer">
            <p class="footer__text">A project made by <a href="Lê Hiếu.github.io" target="_blank" rel="noopener"
                    class="link">Lê Hiếu</a></p>
