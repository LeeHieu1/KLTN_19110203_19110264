 ...
 <nav class="mainNav">
        ...
        <div class="mainNav__wrapper">
            <div class="mainNav__links">
                ...
                <!-- <a class="mainNav__link" href="my_account.php?my_orders">Tài khoản</a> -->
                <!-- <a class="mainNav__link active" href="cart.php">Giỏ hàng</a> -->
                <?php
                    if (!isset($_SESSION['customer_email'])) :?>
                        <a class="mainNav__link active" href="customer/login.php"></a> 
                <?php else :?> 
                    <a class="mainNav__link active" href="cart.php"></a>                
                <?php endif?>
        ...
        <div class="mainNav__menu">
                ...
                if (!isset($_SESSION['customer_email'])) :?>
                        ...
                        <div class="mainNav__shoppingCart">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                id="Capa_1" x="0px" y="0px" viewBox="0 0 489 489" style="enable-background:new 0 0 489 489;"
            ...
            <div class="mainNav__profile">
                <?php
                    ...
                    if (!isset($_SESSION['customer_email'])) {
                        ...
                        if ($customer_image=='') {
                            ...
                            echo "
                                <div class='mainNav__profileImage'>
                                    <img src='customer_images/$customer_image' alt=''>
                                </div>
                            ";
                        }
                    }
                ...
                <div class="mainNav__profileMenu">
                    <a href="customer/my_account.php?my_orders" class="mainNav__profileText account">
                        <?xml version="1.0"?>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                            id="Capa_1" x="0px" y="0px" viewBox="0 0 483.5 483.5"
                            style="enable-background:new 0 0 483.5 483.5;" xml:space="preserve" width="512px"
                            height="512px">
                            <g>
                                <g>
                                    <g>
                    ...
                    <a href="customer/my_account.php?edit_account" class="mainNav__profileText">
                        <?xml version="1.0"?>
                        <svg xmlns="http://www.w3.org/2000/svg" height="512px" viewBox="0 0 431.66 431" width="512px">
                            <g>
                                <path
                                    d="m75.375 370.960938c2.796875 1.996093 6.421875 2.417968 9.601562 1.117187l110.167969-45.09375c1.625-.664063 3.046875-1.746094 4.121094-3.132813l161.113281-208.03125c10.308594-13.3125 14.863282-30.203124 12.636719-46.898437-2.222656-16.691406-11.039063-31.800781-24.480469-41.949219l-18.53125-14c-27.578125-20.683594-66.644531-15.457031-87.816406 11.75l-161.917969 209.515625c-1.230469 1.597657-1.953125 3.53125-2.070312 5.542969l-7 122.46875c-.195313 3.429688 1.382812 6.71875 4.175781 8.710938zm21.6875-110.753907 73.585938 55.1875-78.578126 32.160157zm92.070312 44.050781-87.175781-65.378906 131.488281-170.140625 86.964844 66.019531zm68.878907-267.308593c14.453125-18.566407 41.113281-22.136719 59.9375-8.019531l18.53125 14c9.175781 6.925781 15.191406 17.238281 16.710937 28.632812 1.519532 11.394531-1.589844 22.921875-8.628906 32.011719l-11.90625 15.371093-86.980469-66.03125zm0 0"
                                    data-original="#000000" class="active-path" data-old_color="#000000"
                                    fill="#666666" />
                                <path
                                    d="m421.660156 411.367188h-411.660156c-5.523438 0-10 4.476562-10 10 0 5.523437 4.476562 10 10 10h411.660156c5.523438 0 10-4.476563 10-10 0-5.523438-4.476562-10-10-10zm0 0"
                                    data-original="#000000" class="active-path" data-old_color="#000000"
                                    fill="#666666" />
                            </g>
                        </svg>
                    ...
                    <a href="customer/my_account.php?change_password" class="mainNav__profileText">
                        <?xml version="1.0"?>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                            id="Capa_1" x="0px" y="0px" viewBox="0 0 478.703 478.703"
                            style="enable-background:new 0 0 478.703 478.703;" xml:space="preserve" width="512px"
                            height="512px">
                            <g>
                                <g>
                                    <g>
                    ...
                    <a href="logout.php" class="mainNav__profileText">
                        <?xml version="1.0"?>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                            id="Capa_1" x="0px" y="0px" viewBox="0 0 56 56" style="enable-background:new 0 0 56 56;"
                            xml:space="preserve" width="512px" height="512px">
                            <g>
                                <g>
                                    <path
