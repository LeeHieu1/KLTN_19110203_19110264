    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td data-label="Tên sản phẩm"><a class="tableTitle" href="../details.php?product_id=<?= $product_id; ?>"><?= $product_title; ?></a></td>
                ...
                <td>
                    ...
                    <?php else: ?>
                        <a href="my_account.php?delete=<?=$order_id; ?>" class="delete-btn" title="xoa_san_pham_khoi_gio_hang">Huỷ</a>
                    <?php endif; ?>
                </td>
            </tr>
        <?php } } ?>
